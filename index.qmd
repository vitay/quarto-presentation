...
author:
  - name: Julien Vitay 
    ...
    affiliation: eOdyn Research and Development
    affiliation-url: https://www.eodyn.com
...
```latex
\includegraphics{img/eodyn.png}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{img/eodyn.png}
    \caption{The logo of eOdyn.}
    \label{fig:mesh1}
\end{figure}

```

![](img/eodyn.png){fig-align=center width=50%}
...
![The logo of eOdyn.](img/eodyn.png){width=50%}
```

![The logo of eOdyn.](img/eodyn.png){#fig-logolab width=50%}
:::
